...
import { safeStorage } from "../components/utils/safe-storage";
...
export const useConfigStore = create<IConfigState>()(
  persist(
    ...
    }),
    {
      ...
      skipHydration: true, // Prevents automatic hydration; we manually rehydrate after mount
    }
  )
);

// Hook to manually rehydrate the store after mount, preventing SSR mismatch
