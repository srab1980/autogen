...
const Layout = ({
  ...
  /* Hydration fix: ensure sidebar state matches server (default expanded) until mounted */
    ...
    <div className="min-h-screen flex">
      ...
      <div
        className={classNames(
          ...
          "md:pl-16",
          // Use effectiveExpanded to prevent hydration mismatch
          effectiveExpanded ? "md:pl-72" : "md:pl-16"
        )}
      >
        {showHeader && (
          <ContentHeader
