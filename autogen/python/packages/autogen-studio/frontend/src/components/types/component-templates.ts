...
export const TOOL_TEMPLATES: ComponentTemplate<ToolConfig>[] = [
  ...
  {
    id: "word-export-tool",
    label: "Word Export Tool",
    description: "Export reports to Microsoft Word (.docx) format",
    provider: PROVIDERS.FUNCTION_TOOL,
    component_type: "tool",
    version: 1,
    component_version: 1,
    config: {
      name: "export_to_word",
      description: "Create a .docx report from markdown-like text and return file metadata.",
      source_code: `from typing import Dict, Optional
...
def export_to_word(report_markdown: str, file_name: Optional[str] = None) -> Dict[str, str]:
    ...
    file_name : Optional[str]
        ...
        a default name like 'Report_YYYYMMDD_HHMMSS.docx' will be used.
    ...
    try:
        ...
        # You can change this base directory if you prefer
        base_dir = os.getcwd()
